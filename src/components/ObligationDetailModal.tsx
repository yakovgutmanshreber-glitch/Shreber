...
export function ObligationDetailModal({
  ...
  // Change card in-system: type the new card → GetToken tokenizes → swap the hok.
      ...
      {cardOpen && (
        <div className="mb-4 rounded-xl border border-brand-100 bg-brand-50/40 p-4">
          ...
          <p className="mb-3 rounded-lg bg-blue-50 px-3 py-2 text-xs text-blue-700">
            הזן את הכרטיס החדש. הוא נשלח לקשר לאסימון (טוקן) — <b>ללא חיוב</b>. מספר הכרטיס אינו נשמר
            במערכת, רק הטוקן. ההוראה תעודכן לכרטיס החדש בקשר.
          </p>
